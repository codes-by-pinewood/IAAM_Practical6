...
\begin{figure}[h!]
\centering
\subfloat{\label{fig:depth-cuing-volume_v1}\includegraphics[width=0.5\textwidth]{Images/Depth_Cuing_VolumeViz_t54_c-23_view1.png}}
\subfloat{\label{fig:depth-cuing-volume_v1}\includegraphics[width=0.5\textwidth]{Images/Depth_Cuing_VolumeViz_t54_c-23_view2.png}}
\caption{Figure 
\label{fig:thresholding}
\end{figure}
\begin{figure}[h!]
\centering
\subfloat{\label{fig:depth-cuing-surface_v1}\includegraphics[width=0.5\textwidth]{Images/DepthCuing_SurfaceVisualization_view1.png}}
\subfloat{\label{fig:depth-cuing-surface_v1}\includegraphics[width=0.5\textwidth]{Images/DepthCuing_SurfaceVisualization_view2.png}}
\caption{(a) Chromo.tiff with Otsu Threshold, and (b) Chromo.tiff with Median Filter and Otsu Threshold}
\label{fig:thresholding}
\end{figure}
...
\begin{figure}[h!]
\centering
\subfloat{\label{fig:median-otsu-volume_v1}\includegraphics[width=0.5\textwidth]{Images/BinaryImage_VolumeVisualization_t43_c55_view1.png}}
\subfloat{\label{fig:median-otsu-volume_v2}\includegraphics[width=0.5\textwidth]{Images/BinaryImage_VolumeVisualization_t43_c55_view2.png}}
\caption{(a) Chromo.tiff with Otsu Threshold, and (b) Chromo.tiff with Median Filter and Otsu Threshold}
\label{fig:thresholding}
\end{figure}
...
\begin{figure}[h!]
\centering
\subfloat{\label{fig:median-otsu-surface_v1}\includegraphics[width=0.5\textwidth]{Images/BinaryImage_SurfaceVisualization_view1.png}}
\subfloat{\label{fig:median-otsu-surface_v2}\includegraphics[width=0.5\textwidth]{Images/BinaryImage_SurfaceVisualization_view2.png}}
\caption{(a) Chromo.tiff with Otsu Threshold, and (b) Chromo.tiff with Median Filter and Otsu Threshold}
\label{fig:thresholding}
\end{figure}
