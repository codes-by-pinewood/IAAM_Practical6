...
\begin{figure}[h!]
\centering
\subfloat{\label{fig:median-otsu-surface_v1}\includegraphics[width=0.5\textwidth]{Images/sur.png}}
\subfloat{\label{fig:median-otsu-surface_v2}\includegraphics[width=0.5\textwidth]{Images/BinaryImage_VolumeVisualization_t43_c55_view2.png}}
\caption{(a) Chromo.tiff with Otsu Threshold, and (b) Chromo.tiff with Median Filter and Otsu Threshold}
\label{fig:thresholding}
\end{figure}
